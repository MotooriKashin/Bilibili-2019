...
export class Filter extends HTMLDivElement {
    ...
    /** 推荐视频 */
    $recommend = Element.add('button', { class: 'bofqi-auxiliary-filter-btn', appendTo: this, innerText: '推荐视频' });

    /** 弹幕列表 */
    #danmaku = Element.add('button', { class: 'bofqi-auxiliary-filter-btn', appendTo: this, innerText: '弹幕列表' });

    /** 屏蔽设定 */
    #block = Element.add('button', { class: 'bofqi-auxiliary-filter-btn', appendTo: this, innerText: '屏蔽设定' });
