...
export class Color extends HTMLDivElement {
    ...
    private $theme = Element.add('div', { class: 'bpui-color-row', data: { label: '主题色' }, appendTo: this });

    private $standard = Element.add('div', { class: 'bpui-color-row', data: { label: '标准色' }, appendTo: this });

    private $eye = Element.add('div', { class: 'bpui-color-eye', data: { value: '#ffffff' }, appendTo: this, innerText: '拾色器' });
